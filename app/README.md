...
### Bước 5: Truy vấn CSDL ảo và Mô phỏng Giao dịch
- Chuỗi danh sách món ăn/tổng tiền hoàn chỉnh được dùng để truy vấn trong một cơ sở dữ liệu mẫu
- Nếu tìm thấy thông tin đơn hàng/khách hàng, hệ thống sẽ lấy thông tin tài khoản ảo tương ứng và mô phỏng việc trừ phí. Một bản ghi giao dịch ảo (bao gồm order_id, số tiền, trạng thái "Thành công") sẽ được tạo và lưu vào bảng Transactions.
- Nếu không tìm thấy, một bản ghi giao dịch với trạng thái "Thất bại - Không tìm thấy thông tin đơn hàng" sẽ được tạo.
